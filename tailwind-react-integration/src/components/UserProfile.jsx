function UserProfile() {
  return (
    <div className="user-profile bg-gray-100 p-8 max-w-sm mx-auto,my-20 rounded-lg shadow-lg sm:p-4 md:p-8 sm:max-w-xs md:max-w-sm">
      <img src="https://via.placeholder.com/150" alt="User"className="rounded-full w-36 h-36 mx-auto sm:h-24 w-24 md:h-36 w-36 "
       />
      <h1
      className="text-xl text-blue-800 my-4 sm:text-lg md:text-xl">John Doe</h1>
